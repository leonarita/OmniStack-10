...
function Main({ navigation }) {
    ...
    useEffect(() => {
        async function loadInitialPosition() {
            ...
            if (granted) {
                ...
                setCurrentRegion({latitude: -23.6637347, longitude: -46.661632, latitudeDelta: 0.04, longitudeDelta: 0.04})
            }
        }
    ...
    function setupWebsocket() {
        ...
        connect(-23.6637347, -46.661632, techs)
    }
    ...
    async function loadDevs () {
        ...
        const response = await api.get('/search', {
            params: {
                latitude: -23.6637347, longitude: -46.661632, techs
            }
        })
