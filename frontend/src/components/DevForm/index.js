        ...
        <form onSubmit={handleSubmit}>
            <div className="input-block">
                ...
                <input name="github_username" id="github_username" value={github_username} 
                    onChange={e => setGithub_username(e.target.value)} required />
            ...
            <div className="input-group">
                ...
                <input type="number" name="latitude" id="latitude" value={latitude} 
                    onChange={e => setLatitude(e.target.latitude)} required />
            ...
            <label htmlFor="longitude"> Longitude </label>
                ...
                <input type="number" name="longitude" id="longitude" 
                    value={longitude} onChange={e => setLongitude(e.target.longitude)} required />
